        ...
        <>
          ...
          <Popover>
            <PopoverTrigger asChild>
              <p className="line-clamp-2 cursor-pointer whitespace-pre-wrap break-words text-left text-xs leading-snug transition-opacity hover:opacity-80 focus-visible:outline-2 focus-visible:outline-white">
                {agent.prompt}
              </p>
            </PopoverTrigger>
            <PopoverContent
